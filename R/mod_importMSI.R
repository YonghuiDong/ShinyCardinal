...
#' importMSI Server Functions
#'
#' @noRd
mod_importMSI_server <- function(id, global){
...
# mod_importMSI_ui("importMSI_1")

## To be copied in the server
# mod_importMSI_server("importMSI_1")
