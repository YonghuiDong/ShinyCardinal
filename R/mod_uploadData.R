    ...
    fluidRow(
      ...
      column(width = 5,
             box(
               ...
               collapsed = TRUE,
               closable = FALSE,
               p(style = "color:#C70039;", strong("Step 1. Peak Picking ")),
               ...
               p(style = "color:#C70039;", strong("Step 2. Peak Alignment")),
               ...
               p(style = "color:#C70039;", strong("Step 3. Peak Filter")),
      ...
      column(width = 5,
             box(
               ...
               collapsed = TRUE,
               closable = FALSE,
               p(style = "color:#C70039;", strong("Step 1. Normalization ")),
               ...
               p(style = "color:#C70039;", strong("Step 2. Peak Binning")),
