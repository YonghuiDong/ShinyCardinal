...
<b><span style="color:#6682c4; font-size:30px;">𓅫 Welcome to ShinyCardinal (v0.2.0)</span></b>
...
For further guidance, please watch the <a href="https://www.youtube.com/@MSI_WIS/videos" target="_new">tutorial videos</a>.


<b><span style="color:#5c5d61; font-size:22px;">Demo data</span></b>

You can use the following data sets to experiment and become familiar with ShinyCardinal.. 
...
Please note that the following data sets are distributed under the CC BY 4.0 license. If you intend to use any of them in your publication or other work, please ensure to give proper credit to the authors.
